                                    ...
                                    <tbody id="tableBody">
                                        ...
                                        <tr class="text-center">
                                            <td class="py-2 px-8 border-b border-gray-200 font-semibold">
                                                <a href="#" class="clickable-cell">202015785</a>
                                            </td>
                                            <td class="py-2 px-8 border-b border-gray-200">
                                                <a href="#" class="clickable-cell">Juan dela Cruz</a>
                                            </td>
                                            <td class="py-2 px-8 border-b border-gray-200">
                                                <a href="#" class="clickable-cell">BSIT</a>
                                            </td>
                                            <td class="py-2 px-8 border-b border-gray-200">
                                                <a href="#" class="clickable-cell">Registered</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <div x-show="openTab === 2"
                                ...
                                <table class="w-full bg-white border border-gray-200 rounded-md shadow-md mt-2">
                                    ...
                                    <tbody id="tableEmployee">
                                        ...
                                        <tr class="text-center">
                                            <td class="py-2 px-8 border-b border-gray-200 font-semibold">
                                                <a href="#" class="clickable-cell">0025484</a>
                                            </td>
                                            <td class="py-2 px-8 border-b border-gray-200">
                                                <a href="#" class="clickable-cell">Stan Smith</a>
                                            </td>
                                            <td class="py-2 px-8 border-b border-gray-200">
                                                <a href="#" class="clickable-cell">Registered</a>
                                            </td>
                            ...
                            <div x-show="openTab === 3"
                                ...
                                <table class="w-full bg-white border border-gray-200 rounded-md shadow-md mt-2">
                                    ...
                                    <tbody id="tableStaff">
                                        ...
                                        <tr class="text-center">
                                            <td class="py-2 px-8 border-b border-gray-200 font-semibold">
                                                <a href="#" class="clickable-cell">0124751474</a>
                                            </td>
                                            <td class="py-2 px-8 border-b border-gray-200">
                                                <a href="#" class="clickable-cell">Bruce Wayne</a>
                                            </td>
                                            <td class="py-2 px-8 border-b border-gray-200">
                                                <a href="#" class="clickable-cell">Registered</a>
                                            </td>
                                ...
                                <table class="w-full bg-white border border-gray-200 rounded-md shadow-md mt-2">
                                    ...
                                    <tbody id="tableGuest">
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td class="py-2 px-8 border-b border-gray-200">
                                                <a href="#" class="clickable-cell">Tony Stark</a>
                                            </td>
                                            <td class="py-2 px-8 border-b border-gray-200">
                                                <a href="#" class="clickable-cell">Registered</a>
                                            </td>
